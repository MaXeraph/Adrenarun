...
public static class SpawnManager {
	...
	private static int[,] _grenadierSpawnChances = {{0, 20, 30, 30, 35, 35}};
	private static int[,] _flyingSpawnChances 	 = {{100, 10, 10, 10}};
	private static int[,] _rangedSpawnChances    = {{0, 50, 40, 40, 40, 40}};
