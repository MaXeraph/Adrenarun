...
public static class SpawnManager {
	...
	private static int[,] _flyingSpawnChances 	 = {{10, 15, 15, 15, 15, 10}, {15, 15, 10, 10, 15, 10}, {10, 15, 15, 10, 15, 10}};
	private static int[,] _rangedSpawnChances    = {{40, 35, 30, 30, 30, 30}, {30, 25, 25, 30, 30, 30}, {30, 25, 25, 30, 30, 30}};
	private static int[,] _tankSpawnChances 	 = {{0,  0,  5,  5, 10, 15},   {5,  5,  10,  10, 10, 15}, {10, 10, 10,  10, 10, 15}};
